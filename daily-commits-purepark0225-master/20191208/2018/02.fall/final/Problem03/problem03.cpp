...
public:
	int operation1(){ return member1 * 2; }
	virtual int operation2() { return (member1 + member2) * 2; }
	virtual int operation3() { return (member1 * 2) -1;}
};
...
public:
	virtual int operation2() { return -100*(member1 - member2); }
	virtual int operation3() { return member2 * -3;}
};
...
int main()
{
	...
	std::cout << "Test02" << std::endl;
	{
		...
		Child1 c(20);
		p = &c;
		std::cout << c.operation1()*100 << std::endl;
		std::cout << c.operation2() << std::endl;
		std::cout << c.operation3() << std::endl;
		std::cout << "---" << std::endl;
	...
	std::cout << "Test03" << std::endl;
	{
		...
		std::cout << pc2->operation1()*3 << std::endl;
